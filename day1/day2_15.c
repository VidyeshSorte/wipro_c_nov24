#include <stdio.h>
// Ask the customer if she wish to have Veg or 
// NonVeg and then Show the specific Menu to 
// customer and accept the food-number from 
// the customer and serve her the food.
